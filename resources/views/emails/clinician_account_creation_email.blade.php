              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="d-flex flex-column justify-content-start pt-4 pb-2">
                    ...
                    <h1>Christian School EHR System</h1>
                    <p>Good day! <br /><br />
                      You're receiving this email because the Christian School just created your Electronic Health Record account.<br /><br />
                      Username: {{ $username }}<br />
                      Password: {{ $password }}<br />
                      <br />
                      <p>You can now login your account by using the given credintials above. Click/tap the button bellow to start.</p>
                      <span>
