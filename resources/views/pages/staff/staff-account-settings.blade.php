          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              <div class="tab-pane active show fade pt-3" id="change-username">
                ...
                <form method="POST" action="{{ route('update-save-staff-username', ['id' => $staff_acount['id']]) }}">
                  @csrf
                <div class="row mb-3">
              ...
              <div class="tab-pane fade pt-3" id="change-password">
                <!-- Change Password Form -->
                <form method="POST" action="{{ route('update-save-staff-password', ['id' => $staff_acount['id']]) }}">
                  @csrf
                  <div class="row mb-3">
