                            ...
                            <div class="card-body pt-3">
                                ...
                                <div class="tab-content pt-2">
                                        ...
                                        <form method="POST" action="{{ route('c-save-update-pending-record', ['id' => $c_update_pending['id']]) }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    ...
                                                    <input type='text' name='street_number' id="street_number" value="{{ $c_update_pending->street_number }}" class="form-control mb-3" required />
                                                </div>
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <div class="tab-pane fade profile-edit" id="lab-test">
                                        <form method="POST" action="{{ route('c-save-update-lab-test', ['id' => $c_update_pending['id']]) }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <p class="fs-5 mt-2 mb-4">Laboratory Test</p>
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    <label for="cbc_file">CBC</label>
                                                    <a href="/cbc-folder/{{ $c_update_pending->cbc_file }}">
                                                        <div class="container rounded border img-container">
                                                            <div class="img-lab-test-container">
                                                                <img src="/cbc-folder/{{ $c_update_pending->cbc_file }}" width="150" height="150" />
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    ...
                                                    <a href="/urinalysis-folder/{{ $c_update_pending->urinalysis_file }}">
                                                        <div class="container rounded border img-container">
                                                            <div class="img-lab-test-container">
                                                                <img src="/urinalysis-folder/{{ $c_update_pending->urinalysis_file }}" width="150" height="150" />
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    ...
                                                    <a href="/fecalysis-folder/{{ $c_update_pending->fecalysis_file }}">
                                                        <div class="container rounded border img-container">
                                                            <div class="img-lab-test-container">
                                                                <img src="/fecalysis-folder/{{ $c_update_pending->fecalysis_file }}" width="150" height="150" />
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    ...
                                                    <a href="/xray-folder/{{ $c_update_pending->x_ray_file }}">
                                                        <div class="container rounded border img-container">
                                                            <div class="img-lab-test-container">
                                                                <img src="/xray-folder/{{ $c_update_pending->x_ray_file }}" width="150" height="150" />
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    ...
                                                    <a href="/hba-folder/{{ $c_update_pending->hba_file }}">
                                                        <div class="container rounded border img-container">
                                                            <div class="img-lab-test-container">
                                                                <img src="/hba-folder/{{ $c_update_pending->hba_file }}" width="150" height="150" />
                                                            </div>
                                                        </div>
                                                    </a>
                                                ...
                                                <div class="col-lg-4 col-md-6 col-sm-6">
                                                    ...
                                                    <a href="/hbv-folder/{{ $c_update_pending->hbv_file }}">
                                                        <div class="container rounded border img-container">
                                                            <div class="img-lab-test-container">
                                                                <img src="/hbv-folder/{{ $c_update_pending->hbv_file }}" width="150" height="150" />
                                                            </div>
                                                        </div>
                                                    </a>
                ...
                <div class="modal-dialog modal-dialog-centered modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-4">
                            <form action="{{ route('save-clinician-appointment') }}" method="post" class="row g-3 needs-validation" novalidate>
                                @csrf
