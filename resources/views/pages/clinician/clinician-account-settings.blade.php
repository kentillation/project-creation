          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              <div class="tab-pane active show fade pt-3" id="change-username">
                ...
                <form method="POST" action="{{ route('update-save-clinician-username', ['id' => $clinician_acount['id']]) }}">
                  @csrf
                  <div class="row mb-3">
                  ...
                  <div class="text-center">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#usernameModal">Change Password</button>
                  </div>
              ...
              <div class="tab-pane fade pt-3" id="change-password">
                ...
                <form method="POST" action="{{ route('update-save-clinician-password', ['id' => $clinician_acount['id']]) }}">
                  @csrf
                  <div class="row mb-3">
