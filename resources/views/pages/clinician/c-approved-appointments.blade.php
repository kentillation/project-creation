              ...
              <div class="card-body m-2">
                ...
                <div class="table-responsive">
                  <table class="table table-hover" id="table">
                    ...
                    <tbody>
                      @foreach ($approved_lab_test_appointments as $student_approved_appointment)
                      <tr>
                        <td>{{ $student_approved_appointment->student->first_name }} {{ $student_approved_appointment->student->middle_name }} {{ $student_approved_appointment->student->last_name }}</td>
                        <td>{{ $student_approved_appointment->student->email }}</td>
                        <td>
                          Student Nurse approved the appointment for Laboratory Test in
                          <?php
                          ...
                          ?> which the date was set on {{ $student_approved_appointment->date }} at {{ $student_approved_appointment->time }}.
                        </td>
                      </tr>
                      @endforeach
                    </tbody>
