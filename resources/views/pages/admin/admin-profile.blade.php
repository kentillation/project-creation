          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                <!-- Profile Edit Form -->
                <form action="{{ route('update-save-admin-profile', ['id' => $admin_profile['id']]) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  <div class="row mb-3">
                    <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                    <div class="col-md-8 col-lg-9">
                      <img src="/profile-folder/{{ $admin_profile->image }}" style="height: 100px; width: 100px; border-radius: 50%;" alt="" id="default_pp">
