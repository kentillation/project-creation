                    ...
                    <div class="col-12">
                        <div class="card recent-sales overflow-auto">
                            <div class="card-body m-2">
                                ...
                                <form method="POST"
                                    action="{{ route('a-save-update-pending-record', ['id' => $a_update_pending['id']]) }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-6" style="display: none;">
                                            <label for="student_id">Student ID</label>
                                            <input type='text' name='student_id' id="student_id"
                                                value="{{ $a_update_pending->id }}" class="form-control mb-3" />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="first_name">First Name</label>
                                            <input type='text' name='first_name' id="first_name"
                                                value="{{ $a_update_pending->first_name }}" class="form-control mb-3" />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="middle_name">Middle Name</label>
                                            <input type='text' name='middle_name' id="middle_name"
                                                value="{{ $a_update_pending->middle_name }}"
                                                class="form-control mb-3" />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="last_name">Last Name</label>
                                            <input type='text' name='last_name' id="last_name"
                                                value="{{ $a_update_pending->last_name }}" class="form-control mb-3" />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="street_address">Street Address</label>
                                            <input type='text' name='street_address' id="street_address"
                                                value="{{ $a_update_pending->street_address }}"
                                                class="form-control mb-3" required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="street_number">Street Address</label>
                                            <input type='text' name='street_number' id="street_number"
                                                value="{{ $a_update_pending->street_number }}"
                                                class="form-control mb-3" required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="barangay">Barangay</label>
                                            <input type='text' name='barangay' id="barangay"
                                                value="{{ $a_update_pending->barangay }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="muni_city">Municipality / City</label>
                                            <input type='text' name='muni_city' id="muni_city"
                                                value="{{ $a_update_pending->muni_city }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="date_of_birth">Date of Birth</label>
                                            <input type='date' name='date_of_birth' id="date_of_birth"
                                                value="{{ $a_update_pending->date_of_birth }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="age">Age</label>
                                            <input type='number' name='age' id="age"
                                                value="{{ $a_update_pending->age }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="phone">Phone</label>
                                            <input type='number' name='phone' id="phone"
                                                value="{{ $a_update_pending->phone }}" class="form-control mb-3" />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="civil_status">Civil Status</label>
                                            <input type='text' name='civil_status' id="civil_status"
                                                value="{{ $a_update_pending->civil_status }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="citizenship">Citizenship</label>
                                            <input type='text' name='citizenship' id="citizenship"
                                                value="{{ $a_update_pending->citizenship }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="height">Height (cm)</label>
                                            <input type='text' name='height' id="height"
                                                value="{{ $a_update_pending->height }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="weight">Weight (lbs)</label>
                                            <input type='text' name='weight' id="weight"
                                                value="{{ $a_update_pending->weight }}" class="form-control mb-3"
                                                required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="bmi">BMI</label>
                                            <input type='text' name='bmi' id="bmi" value="{{ $a_update_pending->bmi }}"
                                                class="form-control mb-3" required />
                                        </div>
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <label for="year_level">Year Level</label>
                                            <select id="year_level" name="year_level" class="form-control mb-3">
                                                <option {{ $a_update_pending->year_level_id == 1 ? 'selected' : '' }}
                                                    value="1">1st year</option>
                                                <option {{ $a_update_pending->year_level_id == 2 ? 'selected' : '' }}
                                                    value="2">2nd year</option>
                                                <option {{ $a_update_pending->year_level_id == 3 ? 'selected' : '' }}
                                                    value="3">3rd year</option>
                                                <option {{ $a_update_pending->year_level_id == 4 ? 'selected' : '' }}
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            ...
                                            <select id="section" name="section" class="form-control mb-3">
                                                <option {{ $a_update_pending->section_id == 1 ? 'selected' : '' }}
                                                    value="1">A</option>
                                                <option {{ $a_update_pending->section_id == 2 ? 'selected' : '' }}
                                                    value="2">B</option>
                                                <option {{ $a_update_pending->section_id == 3 ? 'selected' : '' }}
                                                    value="3">C</option>
                                                <option {{ $a_update_pending->section_id == 4 ? 'selected' : '' }}
                                                    value="4">D</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            ...
                                            <select id="gender" name="gender" class="form-control mb-3">
                                                <option {{ $a_update_pending->gender_id == 1 ? 'selected' : '' }}
                                                    value="1">Male</option>
                                                <option {{ $a_update_pending->gender_id == 2 ? 'selected' : '' }}
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            ...
                                            <select id="blood_type" name="blood_type" class="form-control mb-3">
                                                <option {{ $a_update_pending->blood_type_id == 1 ? 'selected' : '' }}
                                                    value="1">A+</option>
                                                <option {{ $a_update_pending->blood_type_id == 2 ? 'selected' : '' }}
                                                    value="2">A-</option>
                                                <option {{ $a_update_pending->blood_type_id == 3 ? 'selected' : '' }}
                                                    value="3">B+</option>
                                                <option {{ $a_update_pending->blood_type_id == 4 ? 'selected' : '' }}
                                                    value="4">B-</option>
                                                <option {{ $a_update_pending->blood_type_id == 5 ? 'selected' : '' }}
                                                    value="5">AB+</option>
                                                <option {{ $a_update_pending->blood_type_id == 6 ? 'selected' : '' }}
                                                    value="6">AB-</option>
                                                <option {{ $a_update_pending->blood_type_id == 7 ? 'selected' : '' }}
                                                    value="7">O+</option>
                                                <option {{ $a_update_pending->blood_type_id == 8 ? 'selected' : '' }}
                                                    value="8">O-</option>
                                            </select>
                                        </div>
