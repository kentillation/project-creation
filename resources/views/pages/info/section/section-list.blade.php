                ...
                <div class="container border rounded p-5 reports">
                    <div class="tbl-top-btns mb-4">
                        <div class="btn-dl me-2">
                            <button class="btn-add-user" type="button" title="Add Section" data-bs-toggle="modal" data-bs-target="#addSectionModal">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-floating mb-4">
                                                <input type="text" id="name" name="section" class="form-control mt-2" placeholder="Section" required/>
