...
@section('page-content')
                ...
                <div class="container border rounded p-5 reports">
                    <div class="tbl-top-btns mb-4">
                        <div class="btn-dl me-2">
                            <button class="btn-add-user" type="button" title="Add Year Level" data-bs-toggle="modal" data-bs-target="#addYearLevelModal">
        ...
        <div class="modal fade" id="addYearLevelModal">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-floating mb-4">
                                                <input type="text" id="name" name="year_level" class="form-control mt-2" placeholder="Year Level" required/>
