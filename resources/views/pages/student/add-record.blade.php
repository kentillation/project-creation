...
@section('page-content')
        ...
        <div id="forLoader" style="display:none;">
            <div class="container mb-5 add-med-rec">
                ...
                @endif
                <div class="container">
                    <p class="page-title">Home / Add Medical Record</p>
                        ...
                        <form method="POST" action="{{ route('save-medical-record') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <input type='text' name='first_name' id="first_name" value="" class="form-control mb-3" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <label for="middle_name">Middle Name</label>
                                    <input type='text' name='middle_name' id="middle_name" value="" class="form-control mb-3" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <label for="last_name">Last Name</label>
                                    <input type='text' name='last_name' id="last_name" value="" class="form-control mb-3" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    ...
                                    <input type='number' name='phone' id="phone" value="" class="form-control mb-3" required />
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
